...
class GatewayController extends Controller
{
    public function index()
    {
        ...
        $gateways = Gateway::orderBy('code')->automatic()->get();
        return view('admin.auto_gateway.index', compact('page_title', 'empty_message', 'gateways'));
    }
    ...
    public function edit($code)
    {
        ...
        return view('admin.auto_gateway.edit', compact('page_title', 'gateway', 'supportedCurrencies', 'parameter_list', 'hasCurrencies', 'currency_idx', 'global_parameters'));
    }
    ...
    public function update(Request $request, $code)
    {
        ...
        return redirect()->route('admin.deposit.gateway.edit', $gateway->code)->with('success', $gateway->name . ' has been updated.');
    }
    ...
    public function activate(Request $request)
    {
        ...
        return redirect()->route('admin.deposit.gateway.index')->with('success', $gateway->name . ' has been activated.');
    }
    ...
    public function deactivate(Request $request)
    {
        ...
        return redirect()->route('admin.deposit.gateway.index')->with('success', $gateway->name . ' has been deactivated.');
