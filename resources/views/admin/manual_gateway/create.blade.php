    ...
    <div class="row ">
        <div class="col-md-12">
            <div class="card">
                ...
                <form id="exampleValidation" method="post" action="{{ route('admin.deposit.manual.store') }}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="delay" placeholder="Processing time"
                                               ...
                                               value="{{ old('delay') }}" required/></div>
                                </div>
                                <hr>
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label>@lang('Minimum Deposit Amount') <span class="text-danger">*</span></label>
                                        ...
                                        <div class="form-group">
                                            <label>@lang('Maximum Deposit Amount') <span class="text-danger">*</span></label>
                                        ...
                                        <div class="form-row" id="userData">
                                            <div class="col-md-4 user-data mt-2">
                                                <input type="text" class="form-control border-radius-5"
                                                       name="verify_image" placeholder="Ask for Image Proof"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
