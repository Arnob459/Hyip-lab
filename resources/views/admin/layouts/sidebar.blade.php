        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <li class="sidebar-item  has-sub">
                    ...
                    <ul class="submenu ">
                        <li class="submenu-item {{ Route::is('admin.sms-template') ? 'active' : '' }}">
                            <a href="{{ route('admin.sms-template') }}">Api Settings</a>
                        </li>
                         <li class="submenu-item {{ Route::is('admin.sms-template.index') ? 'active' : '' }}">
                            <a href="{{ route('admin.sms-template.index') }}">SMS Templetes</a>
                        </li>
