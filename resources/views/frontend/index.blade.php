...
@section('content')
                        ...
                        <div class="row align-items-center">
                            <div class="col-6">
                                <ul class="support-area">
                                    ...
                                    <li>
                                        <a href="Mailto:info@hyipland.com"><i class="flaticon-email"></i><span class="__cf_email__" data-cfemail="ed84838b82ad8594849d818c8389c38e8280">[email&#160;protected]</span> </a>
                                    </li>
                                </ul>
                            </div>
                            <div class="col-6">
        ...
        <section class="banner-section" id="home">
            <div class="banner-bg d-lg-none">
                <img src="{{ asset('assets/frontend/images/banner/banner-bg2.jpg') }}" alt="banner">
            </div>
            <div class="banner-bg d-none d-lg-block bg_img" data-background="{{ asset('assets/frontend/images/banner/banner.jpg') }}">
                <div class="chart-1 wow fadeInLeft" data-wow-delay=".5s" data-wow-duration=".7s">
                    <img src="{{ asset('assets/frontend/images/banner/chart1.png') }}" alt="banner">
                </div>
                <div class="chart-2 wow fadeInDown" data-wow-delay="1s" data-wow-duration=".7s">
                    <img src="{{ asset('assets/frontend/images/banner/chart2.png') }}" alt="banner">
                </div>
                <div class="chart-3 wow fadeInRight" data-wow-delay="1.5s" data-wow-duration=".7s">
                    <img src="{{ asset('assets/frontend/images/banner/chart3.png') }}" alt="banner">
                </div>
                <div class="chart-4 wow fadeInUp" data-wow-delay="2s" data-wow-duration=".7s">
                    <img src="{{ asset('assets/frontend/images/banner/clock.png') }}" alt="banner">
                </div>
            </div>
            <div class="animation-area d-none d-lg-block">
                <div class="plot">
                    <img src="{{ asset('assets/frontend/images/banner/plot.png') }}" alt="banner">
                </div>
                <div class="element-1 wow fadeIn" data-wow-delay="1s">
                    <img src="{{ asset('assets/frontend/images/banner/light.png') }}" alt="banner">
                </div>
                <div class="element-2 wow fadeIn" data-wow-delay="1s">
                    <img src="{{ asset('assets/frontend/images/banner/coin1.png') }}" alt="banner">
                </div>
                <div class="element-3 wow fadeIn" data-wow-delay="1s">
                    <img src="{{ asset('assets/frontend/images/banner/coin2.png') }}" alt="banner">
                </div>
                <div class="element-4 wow fadeIn" data-wow-delay="1s">
                    <img src="{{ asset('assets/frontend/images/banner/coin3.png') }}" alt="banner">
                </div>
                <div class="element-5 wow fadeIn" data-wow-delay="1s">
                    <img src="{{ asset('assets/frontend/images/banner/coin4.png') }}" alt="banner">
                </div>
                <div class="element-6 wow fadeIn" data-wow-delay="1s">
                    <img src="{{ asset('assets/frontend/images/banner/coin5.png') }}" alt="banner">
                </div>
                <div class="element-7 wow fadeIn" data-wow-delay="1s">
                    <img src="{{ asset('assets/frontend/images/banner/coin6.png') }}" alt="banner">
                </div>
                <div class="element-8 wow fadeIn" data-wow-delay="1s">
                    <img src="{{ asset('assets/frontend/images/banner/sheild.png') }}" alt="banner">
                </div>
                <div class="element-9 wow fadeIn" data-wow-delay="1s">
                    <img src="{{ asset('assets/frontend/images/banner/coin7.png') }}" alt="banner">
                </div>
            </div>
            <div class="container">
                <div class="row">
            ...
            <div class="container">
                <div class="row align-items-center mb-30-none justify-content-center">
                    <div class="col-sm-6 col-md-4">
                        <div class="counter-item">
                            <div class="counter-thumb">
                                <img src="{{ asset('assets/frontend/images/counter/counter01.png') }}" alt="counter">
                            </div>
                    ...
                    <div class="col-sm-6 col-md-4">
                        <div class="counter-item">
                            <div class="counter-thumb">
                                <img src="{{ asset('assets/frontend/images/counter/counter02.png') }}" alt="counter">
                            </div>
                            <div class="counter-content">
                                <div class="counter-header">
                    ...
                    <div class="col-sm-6 col-md-4">
                        <div class="counter-item">
                            <div class="counter-thumb">
                                <img src="{{ asset('assets/frontend/images/counter/counter03.png') }}" alt="counter">
                            </div>
                            <div class="counter-content">
                                <div class="counter-header">
                        ...
                        <div class="about--content">
                            <div class="about-item">
                                <div class="about-thumb">
                                    <img src="{{ asset('assets/frontend/images/about/about01.png') }}" alt="about">
                                </div>
                                <div class="about-content">
                            ...
                            <div class="about-item">
                                <div class="about-thumb">
                                    <img src="{{ asset('assets/frontend/images/about/about02.png') }}" alt="about">
                                </div>
                                <div class="about-content">
                            ...
                            <div class="about-item">
                                <div class="about-thumb">
                                    <img src="{{ asset('assets/frontend/images/about/about03.png') }}" alt="about">
                                </div>
                                <div class="about-content">
        ...
        <section class="feature-section padding-top padding-bottom bg_img" data-background="{{ asset('assets/frontend/images/feature/feature-bg.png') }}" id="feature">
            <div class="ball-1" data-paroller-factor="-0.30" data-paroller-factor-lg="0.60"
            data-paroller-type="foreground" data-paroller-direction="horizontal">
                <img src="{{ asset('assets/frontend/images/balls/ball1.png') }}" alt="balls">
            </div>
            <div class="ball-2" data-paroller-factor="-0.30" data-paroller-factor-lg="0.60"
            data-paroller-type="foreground" data-paroller-direction="horizontal">
                <img src="{{ asset('assets/frontend/images/balls/ball2.png') }}" alt="balls">
            </div>
            <div class="ball-3" data-paroller-factor="0.30" data-paroller-factor-lg="-0.30"
            data-paroller-type="foreground" data-paroller-direction="horizontal">
                <img src="{{ asset('assets/frontend/images/balls/ball3.png') }}" alt="balls">
            </div>
            <div class="container">
                ...
                <div class="row justify-content-center feature-wrapper">
                    <div class="col-md-6 col-sm-10 col-lg-4">
                        <div class="feature-item">
                            <div class="feature-thumb">
                                <img src="{{ asset('assets/frontend/images/feature/feature01.png') }}" alt="feature">
                            </div>
                    ...
                    <div class="col-md-6 col-sm-10 col-lg-4">
                        <div class="feature-item">
                            <div class="feature-thumb">
                                <img src="{{ asset('assets/frontend/images/feature/feature02.png') }}" alt="feature">
                            </div>
                            <div class="feature-content">
                    ...
                    <div class="col-md-6 col-sm-10 col-lg-4">
                        <div class="feature-item">
                            <div class="feature-thumb">
                                <img src="{{ asset('assets/frontend/images/feature/feature03.png') }}" alt="feature">
                            </div>
                            <div class="feature-content">
                            ...
                            <div class="hover-tab-area">
                                <div class="tab-area">
                                    <div class="tab-item active first">
                                        <img src="{{ asset('assets/frontend/images/how/how01.png') }}" alt="how">
                                    </div>
                                    <div class="tab-item second">
                                        <img src="{{ asset('assets/frontend/images/how/how02.png') }}" alt="how">
                                    </div>
                                    <div class="tab-item third">
                                        <img src="{{ asset('assets/frontend/images/how/how03.png') }}" alt="how">
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <ul class="tab-menu">
                                    <li class="active">
                                        ...
                                        <div class="menu-content">
                                            ...
                                            <p>
                                                Click <a href="{{ route('register') }}">Sign Up</a> to fill the blank, our 256 SSL will Protect your privacy.
                                            </p>
                                        </div>
                                    </li>
                                    <li>
                                        ...
                                        <div class="menu-content">
                                            ...
                                            <p>
                                                <a href="{{ route('login') }}">Login</a> your account to click invest to start to earn the profit.
                                            </p>
                                        </div>
                                    </li>
                                    <li>
        ...
        <section class="call-section call-overlay bg_img" data-background="{{ asset('assets/frontend/images/call/call-bg.jpg') }}">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-7">
                        <div class="call--item">
                    ...
                    <div class="col-lg-5">
                        <div class="call-button">
                            <a href="Tel:0939303" class="call">
                                <img src="{{ asset('assets/frontend/images/call/icon02.png') }}" alt="call">
                            </a>
                        ...
                        <div class="offer-body">
                            ...
                            <div class="item first">
                                <div class="item-thumb">
                                    <img src="{{ asset('assets/frontend/images/offer/offer1.png') }}" alt="offer">
                                </div>
                            ...
                            <div class="item">
                                <div class="item-thumb">
                                    <img src="{{ asset('assets/frontend/images/offer/offer2.png') }}" alt="offer">
                                </div>
                                <div class="item-content">
        ...
        <section class="profit-section padding-top" id="profit">
            ...
            <div class="container-fluid p-0">
                <div class="profit-bg bg_img" data-background="{{ asset('assets/frontend/images/profit/profit-bg.png') }}">
                    <div class="animation-group">
                        <div class="platform">
                            <img src="{{ asset('assets/frontend/images/profit/platform.png') }}" alt="profit">
                        </div>
                        <div class="light">
                            <img src="{{ asset('assets/frontend/images/profit/light.png') }}" alt="profit">
                        </div>
                        <div class="coin-1 wow fadeOutDown" data-wow-delay="1s">
                            <img src="{{ asset('assets/frontend/images/profit/coin6.png') }}" alt="profit">
                        </div>
                        <div class="coin-2 wow fadeOutDown" data-wow-delay="1s">
                            <img src="{{ asset('assets/frontend/images/profit/coin2.png') }}" alt="profit">
                        </div>
                        <div class="coin-3 wow fadeOutDown" data-wow-delay="1s">
                            <img src="{{ asset('assets/frontend/images/profit/coin3.png') }}" alt="profit">
                        </div>
                        <div class="coin-4 wow fadeOutDown" data-wow-delay="1s">
                            <img src="{{ asset('assets/frontend/images/profit/coin4.png') }}" alt="profit">
                        </div>
                        <div class="coin-5 wow fadeOutDown" data-wow-delay="1s">
                            <img src="{{ asset('assets/frontend/images/profit/coin5.png') }}" alt="profit">
                        </div>
                        <div class="coin-6 wow fadeOutDown" data-wow-delay="1s">
                            <img src="{{ asset('assets/frontend/images/profit/coin1.png') }}" alt="profit">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="latest-transaction padding-top padding-bottom" id="transaction">
            <div class="transaction-bg bg_img" data-background="{{ asset('assets/frontend/images/transaction/transaction-bg.png') }}">
                            ...
                            <div class="row justify-content-center mb-30-none">
                                <div class="col-lg-4 col-xl-3 col-sm-6">
                                    <div class="transaction-item">
                                        ...
                                        <div class="transaction-thumb">
                                            <img src="{{ asset('assets/frontend/images/transaction/transaction01.png') }}" alt="transaction">
                                        </div>
                                ...
                                <div class="col-lg-4 col-xl-3 col-sm-6">
                                    <div class="transaction-item">
                                        ...
                                        <div class="transaction-thumb">
                                            <img src="{{ asset('assets/frontend/images/transaction/transaction02.png') }}" alt="transaction">
                                        </div>
                                        <div class="transaction-footer">
                                            <span class="amount">Amount</span>
                                ...
                                <div class="col-lg-4 col-xl-3 col-sm-6">
                                    <div class="transaction-item">
                                        ...
                                        <div class="transaction-thumb">
                                            <img src="{{ asset('assets/frontend/images/transaction/transaction03.png') }}" alt="transaction">
                                        </div>
                                        <div class="transaction-footer">
                                            <span class="amount">Amount</span>
                                ...
                                <div class="col-lg-4 col-xl-3 col-sm-6">
                                    <div class="transaction-item">
                                        ...
                                        <div class="transaction-thumb">
                                            <img src="{{ asset('assets/frontend/images/transaction/transaction04.png') }}" alt="transaction">
                                        </div>
                                        <div class="transaction-footer">
                                            <span class="amount">Amount</span>
                                ...
                                <div class="col-lg-4 col-xl-3 col-sm-6">
                                    <div class="transaction-item">
                                        ...
                                        <div class="transaction-thumb">
                                            <img src="{{ asset('assets/frontend/images/transaction/transaction05.png') }}" alt="transaction">
                                        </div>
                                        <div class="transaction-footer">
                                            <span class="amount">Amount</span>
                                ...
                                <div class="col-lg-4 col-xl-3 col-sm-6">
                                    <div class="transaction-item">
                                        ...
                                        <div class="transaction-thumb">
                                            <img src="{{ asset('assets/frontend/images/transaction/transaction06.png') }}" alt="transaction">
                                        </div>
                                        <div class="transaction-footer">
                                            <span class="amount">Amount</span>
                                            <h5 class="sub-title">0.00449721 XRP</h5>
                                ...
                                <div class="col-lg-4 col-xl-3 col-sm-6">
                                    <div class="transaction-item">
                                        ...
                                        <div class="transaction-thumb">
                                            <img src="{{ asset('assets/frontend/images/transaction/transaction07.png') }}" alt="transaction">
                                        </div>
                                        <div class="transaction-footer">
                                            <span class="amount">Amount</span>
                                            <h5 class="sub-title">0.00449721 USD</h5>
                                ...
                                <div class="col-lg-4 col-xl-3 col-sm-6">
                                    <div class="transaction-item">
                                        ...
                                        <div class="transaction-thumb">
                                            <img src="{{ asset('assets/frontend/images/transaction/transaction08.png') }}" alt="transaction">
                                        </div>
                                        <div class="transaction-footer">
                                            <span class="amount">Amount</span>
                                            <h5 class="sub-title">0.00449721 LTC</h5>
                            ...
                            <div class="row justify-content-center mb-30-none">
                                ...
                                <div class="col-lg-4 col-xl-3 col-sm-6">
                                    <div class="transaction-item">
                                        ...
                                        <div class="transaction-thumb">
                                            <img src="{{ asset('assets/frontend/images/banner/coin7.png') }}assets/images/transaction/transaction01.png" alt="transaction">
                                        </div>
                                        <div class="transaction-footer">
                                            <span class="amount">Amount</span>
                                            <h5 class="sub-title">0.00449721 BTC</h5>
                                ...
                                <div class="col-lg-4 col-xl-3 col-sm-6">
                                    <div class="transaction-item">
                                        ...
                                        <div class="transaction-thumb">
                                            <img src="{{ asset('assets/frontend/images/banner/coin7.png') }}assets/images/transaction/transaction02.png" alt="transaction">
                                        </div>
                                        <div class="transaction-footer">
                                            <span class="amount">Amount</span>
                                            <h5 class="sub-title">0.00449721 ETH</h5>
                                ...
                                <div class="col-lg-4 col-xl-3 col-sm-6">
                                    <div class="transaction-item">
                                        ...
                                        <div class="transaction-thumb">
                                            <img src="{{ asset('assets/frontend/images/banner/coin7.png') }}assets/images/transaction/transaction03.png" alt="transaction">
                                        </div>
                                        <div class="transaction-footer">
                                            <span class="amount">Amount</span>
                                            <h5 class="sub-title">0.00449721 LTC</h5>
                                ...
                                <div class="col-lg-4 col-xl-3 col-sm-6">
                                    <div class="transaction-item">
                                        ...
                                        <div class="transaction-thumb">
                                            <img src="{{ asset('assets/frontend/images/banner/coin7.png') }}assets/images/transaction/transaction04.png" alt="transaction">
                                        </div>
                                        <div class="transaction-footer">
                                            <span class="amount">Amount</span>
                                            <h5 class="sub-title">0.00449721 XRP</h5>
                                ...
                                <div class="col-lg-4 col-xl-3 col-sm-6">
                                    <div class="transaction-item">
                                        ...
                                        <div class="transaction-thumb">
                                            <img src="{{ asset('assets/frontend/images/banner/coin7.png') }}assets/images/transaction/transaction05.png" alt="transaction">
                                        </div>
                                        <div class="transaction-footer">
                                            <span class="amount">Amount</span>
                                            <h5 class="sub-title">0.00449721 USD</h5>
                                ...
                                <div class="col-lg-4 col-xl-3 col-sm-6">
                                    <div class="transaction-item">
                                        ...
                                        <div class="transaction-thumb">
                                            <img src="{{ asset('assets/frontend/images/banner/coin7.png') }}assets/images/transaction/transaction06.png" alt="transaction">
                                        </div>
                                        <div class="transaction-footer">
                                            <span class="amount">Amount</span>
                                            <h5 class="sub-title">0.00449721 XRP</h5>
                            ...
                            <div class="row justify-content-center mb-30-none">
                                ...
                                <div class="col-lg-4 col-xl-3 col-sm-6">
                                    <div class="transaction-item">
                                        ...
                                        <div class="transaction-thumb">
                                            <img src="{{ asset('assets/frontend/images/banner/coin7.png') }}assets/images/transaction/transaction07.png" alt="transaction">
                                        </div>
                                        <div class="transaction-footer">
                                            <span class="amount">Amount</span>
                                            <h5 class="sub-title">0.00449721 USD</h5>
                                ...
                                <div class="col-lg-4 col-xl-3 col-sm-6">
                                    <div class="transaction-item">
                                        ...
                                        <div class="transaction-thumb">
                                            <img src="{{ asset('assets/frontend/images/banner/coin7.png') }}assets/images/transaction/transaction08.png" alt="transaction">
                                        </div>
                                        <div class="transaction-footer">
                                            <span class="amount">Amount</span>
                                            <h5 class="sub-title">0.00449721 LTC</h5>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-5 d-lg-block d-none">
                        <div class="afiliate-thumb">
                            <img src="{{ asset('assets/frontend/images/affiliate/affiliate.png') }}" alt="affiliate">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row align-items-center">
                    <div class="col-md-7 col-xl-6">
                        <div class="call-item text-center text-sm-left">
                            <div class="call-icon">
                                <img src="{{ asset('assets/frontend/images/call/icon01.png') }}" alt="call">
                            </div>
        ...
        <section class="client-section padding-bottom padding-top">
            <div class="background-map">
                <img src="{{ asset('assets/frontend/images/client/client-bg.png') }}" alt="client">
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 col-md-10">
                ...
                <div class="container">
                    <div class="newslater-area">
                        ...
                        <div class="newslater-thumb">
                            <img src="{{ asset('assets/frontend/images/footer/footer.png') }}" alt="footer">
                            <div class="coin-1">
                                <img src="{{ asset('assets/frontend/images/footer/Coin_01.png') }}" alt="footer">
                            </div>
                            <div class="coin-2">
                                <img src="{{ asset('assets/frontend/images/footer/Coin_02.png') }}" alt="footer">
                            </div>
                            <div class="coin-3">
                                <img src="{{ asset('assets/frontend/images/footer/Coin_03.png') }}" alt="footer">
                            </div>
                            <div class="coin-4">
                                <img src="{{ asset('assets/frontend/images/footer/Coin_04.png') }}" alt="footer">
                            </div>
                            <div class="coin-5">
                                <img src="{{ asset('assets/frontend/images/footer/Coin_05.png') }}" alt="footer">
                            </div>
                            <div class="coin-6">
                                <img src="{{ asset('assets/frontend/images/footer/Coin_06.png') }}" alt="footer">
                            </div>
                        </div>
                    </div>
                </div>
