            ...
            <div class="row">
                <div class="col-sm-3 col-5">
                    <div class="left-info">
                        ...
                        <p>@lang('Receivable')  {{$log->currency}} :</p>
                        <p>@lang('Transaction ID') :</p>
                        <p>@lang('Admin Feedback'):</p>
                        <p>@lang('Status') :</p>
                        <p>@lang('Request At') :</p>
                ...
                <div class="col-sm-9 col-7">
                    <div class="right-info">
                        ...
                        <p>{{formatter_money($log->after_charge)}} {{$gnl->cur}}</p>
                        <p> = {{$log->rate+0}} {{$log->currency}} <code>(@lang('site Currency = Method Currency')</code></p>
                        <p>{{$log->after_charge * $log->rate}} {{$log->currency}}</p>
                        <p>#{{$log->trx}}</p>
                        <p>#{{$log->admin_feedback}}</p>
                        <p>
                            @if($log->status == 1)
